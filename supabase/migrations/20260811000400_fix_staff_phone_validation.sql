alter table public.timefit_user_staff drop constraint if exists timefit_user_staff_phone_e164_check;
alter table public.timefit_user_staff add constraint timefit_user_staff_phone_e164_check check (phone_e164 is null or phone_e164 ~ E'^\\+[1-9][0-9]{7,14}$');
